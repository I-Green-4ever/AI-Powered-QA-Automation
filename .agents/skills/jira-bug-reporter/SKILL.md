...
5. **Save local draft** to Block6/bugs/ (see Output)
...
## Output
Create Block6/bugs/ if missing
Save draft as Block6/bugs/[IreneG]-<related-story-or-slug>-bug.md.
Example: Block6/bugs/[IreneG]-DS-1-create-button-enabled-bug.md
